    ...
    <div >
      ...
      <form onSubmit={e => e.preventDefault()}>
        <div className='absolute top-[30%] md:top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 '>
          ...
          <input type='text' ref={inputText} className='rounded-2xl md:rounded-l-xl md:rounded-none w-[360px] md:w-[500px] pl-3 py-3 text-white bg-gray-700 outline-none ' placeholder={lang[choosenlang].gptSearchPlaceholder}></input>
